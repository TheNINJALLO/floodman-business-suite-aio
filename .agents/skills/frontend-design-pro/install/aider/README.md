...
**Degradation:** no on-demand loader — whatever you add read-only is in context and nothing else is. The 116 reference files reach the model only when you name one and add it.
