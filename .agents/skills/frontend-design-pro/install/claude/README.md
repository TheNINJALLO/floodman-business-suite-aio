...
This is the only host with a real filesystem, so lazy loading works as designed: `SKILL.md` (2,126 tokens) always loaded, one matched skill plus its core deps, ~6,014–7,927 tokens per request against 415,028 tokens of on-demand depth.
