# Release Notes — frontend-design-pro v14.2.3

**Date:** 2026-08-01
**Archive:** `frontend-design-pro-v14.2.3.skill` — 1140 KB, 294 files, ~368,429 tokens of markdown, root `frontend-design-pro/`
**Pipeline wall-clock:** 60.3s
...
Registry (`SKILL.md`) is 1,837 tokens and is the only file always loaded.
...
```bash
unzip frontend-design-pro-v14.2.3.skill -d ~/.claude/skills/
```
