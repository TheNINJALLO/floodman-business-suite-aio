# Release Notes — frontend-design-pro v14.1.1

**Date:** 2026-07-28
**Archive:** `frontend-design-pro-v14.1.1.skill` — 874 KB, 221 files, ~342,007 tokens of markdown, root `frontend-design-pro/`
**Pipeline wall-clock:** 56.0s
...
```bash
unzip frontend-design-pro-v14.1.1.skill -d ~/.claude/skills/
```
