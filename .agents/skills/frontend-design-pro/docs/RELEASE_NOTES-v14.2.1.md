# Release Notes — frontend-design-pro v14.2.1

**Date:** 2026-07-29
**Archive:** `frontend-design-pro-v14.2.1.skill` — 999 KB, 273 files, ~360,146 tokens of markdown, root `frontend-design-pro/`
**Pipeline wall-clock:** 115.9s
...
```bash
unzip frontend-design-pro-v14.2.1.skill -d ~/.claude/skills/
```
