# Release Notes — frontend-design-pro v14.4.0

**Date:** 2026-08-02
**Archive:** `frontend-design-pro-v14.4.0.skill` — 1184 KB, 310 files, ~386,766 tokens of markdown, root `frontend-design-pro/`
**Pipeline wall-clock:** 97.7s

## Contents

17 skills · 8 core files · 86 references (320,375 tokens of on-demand depth) · 45 examples (39 gold + 6 anti-examples) · 39 tests · 51 constraints (16 semantic + 35 syntactic)

Registry (`SKILL.md`) is 1,888 tokens and is the only file always loaded.
...
| Semantic | PASS | 53/53 files (39 golds + 14 demo) pass 16/16 parser checks |
...
| Test coverage | PASS | 39/39 golds have a 1:1 test; all test files compile strict (runtime exec out of scope — examples stub their peer deps) |
...
```bash
unzip frontend-design-pro-v14.4.0.skill -d ~/.claude/skills/
```
