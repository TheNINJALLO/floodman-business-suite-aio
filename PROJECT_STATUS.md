...
|---|---:|---|---|
| Floodman custom server | 4.6.9 | Workspace-boundary repair packaged; 10/10 source smokes pass | Live v4.6.9 upgrade and Full ERP/RoomFlow route validation not yet performed |
| Pterodactyl launcher | 4.6.9 | Refreshed deterministic launcher/egg/163-file runtime built and checksummed | Must be tested on Wings after backup |
