...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            square_base_url=os.getenv("SQUARE_BASE_URL", "http://127.0.0.1:9003/square"),
            ...
            roomflow_url=os.getenv("ROOMFLOW_WEB_URL", "https://theninjallo.github.io/roomflow/").rstrip("/"),
