...
: "${ROOMFLOW_WEB_URL:=https://theninjallo.github.io/roomflow/}"
...
export FLOODMAN_RELEASE="pterodactyl-aio-v3.1.1"
...
# Genuine Gauzy integration and branding.
...
export AI_SCHEDULE_SECONDS="604800" AI_MAX_RUNS_PER_DAY="30" AI_MAX_PAGES_PER_TARGET="5" AI_MAX_RESPONSE_BYTES="2097152" AI_MAX_ANALYSIS_CHARS="60000" AI_USER_AGENT="FloodmanBusinessSuite-Pterodactyl-AIO/3.1.1" AI_ALLOW_HTTP="true"
...
export OFFICE_CONSOLE_PUBLIC_URL="$MAIN_PUBLIC_URL" OFFICE_CONSOLE_DATA_DIR="$FM_DATA/office" OFFICE_AUTH_ENABLED="true"
...
export APP_NAME="Floodman Operations" APP_SIGNATURE="Floodman Operations" APP_LINK="$MAIN_PUBLIC_URL" APP_EMAIL_CONFIRMATION_URL="${MAIN_PUBLIC_URL}/#/auth/confirm-email" APP_MAGIC_SIGN_URL="${MAIN_PUBLIC_URL}/#/auth/magic-sign-in"
...
# Gauzy feature flags used by Floodman.
set -a
...
export NEXT_PRIVATE_SMTP_FROM_NAME="Floodman Signing" NEXT_PRIVATE_SMTP_FROM_ADDRESS="$FLOODMAN_OWNER_EMAIL" NEXT_PUBLIC_DOCUMENT_SIZE_UPLOAD_LIMIT="25" NEXT_PUBLIC_DISABLE_SIGNUP="false" DOCUMENSO_DISABLE_TELEMETRY="true"

# Hub launcher values.
export HUB_TITLE="Floodman Operations Hub" HUB_RELEASE="pterodactyl-aio-v3.1.1" HUB_OFFICE_URL="$MAIN_PUBLIC_URL" HUB_ROOMFLOW_URL="$ROOMFLOW_WEB_URL"
...
fm_log "Main Floodman Gauzy Hub: $MAIN_PUBLIC_URL"
