...
export FLOODMAN_RELEASE="pterodactyl-mobile-v4.7.1"
...
export AI_SCHEDULE_SECONDS="604800" AI_MAX_RUNS_PER_DAY="30" AI_MAX_PAGES_PER_TARGET="5" AI_MAX_RESPONSE_BYTES="2097152" AI_MAX_ANALYSIS_CHARS="60000" AI_USER_AGENT="FloodmanBusinessSuite-Pterodactyl-Mobile/4.7.1" AI_ALLOW_HTTP="true"
...
# Hub launcher values.
export HUB_TITLE="Floodman Operations Hub" HUB_RELEASE="pterodactyl-mobile-v4.7.1" HUB_OFFICE_URL="$MAIN_PUBLIC_URL" HUB_ROOMFLOW_URL="$ROOMFLOW_WEB_URL"
