...
AI_CALLING_HMAC_KEYS=call-v1:${ai_hmac}
...
export FLOODMAN_RELEASE="pterodactyl-mobile-v4.7.2"
...
export AI_CALLING_ENABLED="true" AI_CALLING_APPROVED="false" AI_CALLING_PROVIDER="deterministic" AI_CALLING_WEBHOOK_URL="${API_PUBLIC_URL}/webhooks/ai-calling/deterministic"
...
export AI_SCHEDULE_SECONDS="604800" AI_MAX_RUNS_PER_DAY="30" AI_MAX_PAGES_PER_TARGET="5" AI_MAX_RESPONSE_BYTES="2097152" AI_MAX_ANALYSIS_CHARS="60000" AI_USER_AGENT="FloodmanBusinessSuite-Pterodactyl-Mobile/4.7.2" AI_ALLOW_HTTP="true"
...
export APP_LOGO="${MAIN_PUBLIC_URL}/floodman-brand/floodman-wordmark.svg"
export NO_INTERNET_LOGO="$APP_LOGO" PLATFORM_LOGO="$APP_LOGO" GAUZY_DESKTOP_LOGO_512X512="${MAIN_PUBLIC_URL}/floodman-brand/floodman-mark.svg"
...
# Hub launcher values.
export HUB_TITLE="Floodman Operations Hub" HUB_RELEASE="pterodactyl-mobile-v4.7.2" HUB_OFFICE_URL="$MAIN_PUBLIC_URL" HUB_ROOMFLOW_URL="$ROOMFLOW_WEB_URL"
export HUB_VOICE_URL="${FLOODMAN_VOICE_URL:-https://aicall.oninetwork.com}"
...
export HUB_REMOTE_DOCUMENSO_PORT="$DOCUMENSO_PORT" HUB_REMOTE_MAILPIT_PORT="$MAILPIT_PORT" HUB_REMOTE_ENGINEERING_PORT="$ENGINEERING_PORT" HUB_REMOTE_API_PORT="$FLOODMAN_API_PORT" HUB_REMOTE_DOCUMENSO_URL="" HUB_REMOTE_MAILPIT_URL="" HUB_REMOTE_ENGINEERING_URL="" HUB_REMOTE_API_URL=""
