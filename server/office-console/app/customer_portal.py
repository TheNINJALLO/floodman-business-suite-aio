...
.field textarea{width:100%;min-height:120px;padding:12px;border:1px solid var(--line);border-radius:10px;background:#fff;font:inherit;resize:vertical}.field small{display:block;margin-top:6px;color:var(--muted);line-height:1.4}.portal-conversation{scroll-margin-top:18px}.portal-message-title{display:flex;align-items:flex-start;justify-content:space-between;gap:14px}.portal-message-title h2{margin:5px 0}.portal-message-title p{margin:0;color:var(--muted)}.portal-message-list{display:grid;gap:10px;margin:18px 0;max-height:520px;overflow:auto;padding:2px}.portal-message{max-width:84%;padding:12px 14px;border:1px solid var(--line);border-radius:14px;background:#f4f7f9}.portal-message.staff{justify-self:start;border-color:#badce8;background:var(--pale)}.portal-message.customer{justify-self:end;border-color:#cbe4bf;background:var(--good)}.portal-message-head{display:flex;justify-content:space-between;gap:16px;color:var(--navy);font-size:13px}.portal-message-head span{color:var(--muted);font-size:11px}.portal-message p{margin:7px 0 0;line-height:1.5;overflow-wrap:anywhere}.portal-message-form{margin-top:16px;padding-top:16px;border-top:1px solid var(--line)}.portal-honeypot{position:absolute!important;width:1px!important;height:1px!important;overflow:hidden!important;clip:rect(1px,1px,1px,1px)!important;white-space:nowrap!important}
@media(max-width:700px){.shell{padding:16px 12px 80px}.grid,.pay-row{grid-template-columns:1fr}.line{grid-template-columns:minmax(0,1fr) 64px 76px;gap:8px;font-size:13px}.line>div{min-width:0;overflow-wrap:anywhere}.hero h2{font-size:27px}.brand h1{font-size:20px}.button,button{width:100%;min-height:48px}.actions{display:grid}.print-link{float:none;margin-top:8px}.portal-message-title{display:block}.portal-message-title .status{margin-top:10px}.portal-message{max-width:94%}.portal-message-head{display:block}.portal-message-head span{display:block;margin-top:2px}}
