...
def template_files() -> dict[str, bytes]:
    ...
    # The specialized one-file customer importer accepts common exports without
    # requiring the complete historical archive format.
    from .customer_csv import customer_template
    values["customers.csv"] = customer_template()
    values["README.txt"] = (
