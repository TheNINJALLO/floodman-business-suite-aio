...
def run() -> None:
    ...
    assert "/home/container/runtime/floodman-v4.6.8/app-overlay/floodman-operations-v4.6.8/" in nginx
    ...
    os.environ.update(
        {
            ...
            "FLOODMAN_RELEASE": "pterodactyl-mobile-v4.6.8",
    ...
    assert "floodman-workspace.css?release=4.6.8" in desktop.text
