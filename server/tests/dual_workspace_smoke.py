...
def run() -> None:
    ...
    assert "/home/container/runtime/floodman-v4.6.9/app-overlay/floodman-operations-v4.6.9/" in nginx
    ...
    os.environ.update(
        {
            ...
            "FLOODMAN_RELEASE": "pterodactyl-mobile-v4.6.9",
    ...
    assert "floodman-workspace.css?release=4.6.9" in desktop.text
