...
def run() -> None:
    ...
    assert "/home/container/runtime/floodman-v4.6.10/app-overlay/floodman-operations-v4.6.10/" in nginx
    ...
    os.environ.update(
        {
            ...
            "FLOODMAN_RELEASE": "pterodactyl-mobile-v4.6.10",
    ...
    assert "floodman-workspace.css?release=4.6.10" in desktop.text
