...
| T-003 | Generated inventory | `python scripts/generate_inventory.py` | PASS | 2026-08-12 RoomFlow milestone refresh: 310 routes, 180 environment names, 557 inventoried files, 74,957 text lines; ignored virtual environments, vendor checkout, and test caches are excluded. |
