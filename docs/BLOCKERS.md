...
| BLK-004 | iOS compilation | OPEN | Xcode and an iOS simulator require a macOS runner. | 2026-08-15 alpha03 source/project/asset/workflow readiness, including the guided settings refresh, is complete; run the checksum-producing unsigned simulator workflow on macOS 26/Xcode 26. |
