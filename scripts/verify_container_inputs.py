...
for token in ('org.opencontainers.image.version="4.6.10"', 'org.opencontainers.image.authors="Josh Aldrich"', "EXPRESS_SESSION_SECRET=", "JWT_SECRET=", "JWT_REFRESH_TOKEN_SECRET="):
