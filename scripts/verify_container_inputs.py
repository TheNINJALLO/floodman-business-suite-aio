...
for token in ('org.opencontainers.image.version="4.7.2"', 'org.opencontainers.image.authors="Josh Aldrich"', "EXPRESS_SESSION_SECRET=", "JWT_SECRET=", "JWT_REFRESH_TOKEN_SECRET="):
