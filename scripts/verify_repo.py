...
expected = {
    ROOT / "server" / "VERSION": "4.6.8",
    ROOT / "apps" / "android" / "VERSION": "0.3.0-alpha11",
    ROOT / "apps" / "ios" / "VERSION": "0.1.0-alpha02",
...
if overlay.get("version") != "4.6.8":
    error("server/overlay.json is not v4.6.8")
