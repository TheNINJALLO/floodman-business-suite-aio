...
|---|---:|---|
| Floodman server overlay | 4.7.3 | Simplified daily workspace with customer-scoped property selection, retaining v4.7.2 call intake and notifications |
| Pterodactyl launcher | 4.7.3 | Current cumulative launcher and deterministic upload package |
...
- Complete Floodman custom server source for v4.7.3
