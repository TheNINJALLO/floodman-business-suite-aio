...
derivative-image:
	docker build --pull --no-cache -f containers/derivative/Dockerfile -t floodman-operations:4.7.3 .

server-image:
	docker build --pull --no-cache -f containers/base-aio/Dockerfile -t floodman-business-suite-aio:4.7.3 .
